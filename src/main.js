...
const mods = [
    // rainbow
    'Радуга', 'Статичный цвет', 'Переливка', 'Радуга волнами', ' Бегущие цвета',
    'Радуга волнами к центру', 'Красный-радуга', 'Обратная радуга', 'Радуга с промежутком',
    // anather_colors
    'Случайные цвета', 'Бегущий С/К', 'Вращающийся С/К', 'Бегущий патриотизм',
    ...
    'Плавное\nвозгорание/затухание', 'Черви к центру',
...
const mods_comment = [
    ...
    'Заполнение случайного светодиода случайным цветом',
    ...
    'Случайное появление и погасание светодиодов', 'Аналог полицейских проблесковых маячков',
    'Бегущие по кругу красный зелёный синий', 'Имитация горения огня\n(на ленте выглядит красивее)',
    'Плавная переливка от белого к случайному цвету',
    ...
    'Плавное изменение яркости выбранного цвета',
    'Движение синусоид выбранного цвета к центру\n(на ленте выглядит понятнее)',
    'Бегущий огонёк заданного цвета по кругу', 'Огромная синусоида выбранного цвета',
    'Плавная волна случайно изменающая свои размеры (на ленте реализованно плавнее, с js я не сосбо подружился)',
    'Случайно появляющиеся светодиоды бегущие вправо',
    'Появление волны случайного размера двигающейся вправо',
    'Бегущая синусойда', 'Синусойды заданного цвета двигающиеся влево',
    'Светодиоды заданного цвета направленные влево с промежутком в 2 светодиода',
    'Случайное появление заданного цвета случайной яркости',
    'Поочерёдное заполнение ленты синусоидами заданного цвета',
    '2 светодиода заданного цвета бегущие к центру',
    'Случайное появление/пропадание заданного цвета',
    'Прыгающие мячики (js не хочет нормально отображать, в прошивке на ленты необходиво изменить переменную "BallCount")'
]
